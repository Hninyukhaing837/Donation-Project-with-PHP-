<h2 class="text-uppercase text-info" style="text-indent: 30%;">Donor's Dashboard</h2>
<hr class="text-danger shadow-sm">
<div class="container">
    <div class="row">
        <?php
...
<!--            <div class="col mb-3"><img src="--><?php //echo $url; ?><!--/app-assets/img/sidebar-bg/01.jpg" width="50" height="100" alt="Bg image1" class="rounded box-shadow-2"></div>-->
<!--            <div class="col mb-3"><img src="--><?php //echo $url; ?><!--/app-assets/img/sidebar-bg/02.jpg" width="50" height="100" alt="Bg image2" class="rounded box-shadow-2"></div>-->
<!--            <div class="col mb-3"><img src="--><?php //echo $url; ?><!--/app-assets/img/sidebar-bg/03.jpg" width="50" height="100" alt="Bg image3" class="rounded box-shadow-2"></div>-->
<!--            <div class="col mb-3"><img src="--><?php //echo $url; ?><!--/app-assets/img/sidebar-bg/04.jpg" width="50" height="100" alt="Bg image4" class="rounded box-shadow-2"></div>-->
<!--            <div class="col mb-3"><img src="--><?php //echo $url; ?><!--/app-assets/img/sidebar-bg/05.jpg" width="50" height="100" alt="Bg image5" class="rounded box-shadow-2"></div>-->
<!--            <div class="col mb-3"><img src="--><?php //echo $url; ?><!--/app-assets/img/sidebar-bg/06.jpg" width="50" height="100" alt="Bg image6" class="rounded box-shadow-2"></div>-->
<!--            <div class="col mb-3"><img src="--><?php //echo $url; ?><!--/app-assets/img/sidebar-bg/07.jpg" width="50" height="100" alt="Bg image7" class="rounded box-shadow-2"></div>-->
<!--            <div class="col mb-3"><img src="--><?php //echo $url; ?><!--/app-assets/img/sidebar-bg/08.jpg" width="50" height="100" alt="Bg image8" class="rounded box-shadow-2"></div>-->
<!--        </div>-->
<!--        <hr>-->
<!--        <div class="togglebutton">-->
...
<!-- BEGIN VENDOR JS-->
<script src="<?php echo $url; ?>/app-assets/vendors/js/core/jquery-3.3.1.min.js"></script>
<script src="<?php echo $url; ?>/app-assets/vendors/js/core/popper.min.js"></script>
<script src="<?php echo $url; ?>/app-assets/vendors/js/core/bootstrap.min.js"></script>
<script src="<?php echo $url; ?>/app-assets/vendors/js/perfect-scrollbar.jquery.min.js"></script>
<script src="<?php echo $url; ?>/app-assets/vendors/js/prism.min.js"></script>
<script src="<?php echo $url; ?>/app-assets/vendors/js/jquery.matchHeight-min.js"></script>
<script src="<?php echo $url; ?>/app-assets/vendors/js/screenfull.min.js"></script>
<script src="<?php echo $url; ?>/app-assets/vendors/js/pace/pace.min.js"></script>
<!-- BEGIN VENDOR JS-->
<!-- BEGIN PAGE VENDOR JS-->
<script src="<?php echo $url; ?>/app-assets/vendors/js/chartist.min.js"></script>
<!-- END PAGE VENDOR JS-->
<!-- BEGIN CONVEX JS-->
<script src="<?php echo $url; ?>/app-assets/js/app-sidebar.js"></script>
<script src="<?php echo $url; ?>/app-assets/js/notification-sidebar.js"></script>
<script src="<?php echo $url; ?>/app-assets/js/customizer.js"></script>
<!-- END CONVEX JS-->
<!-- BEGIN PAGE LEVEL JS-->
<script src="<?php echo $url; ?>/app-assets/js/dashboard-ecommerce.js"></script>
<!-- END PAGE LEVEL JS-->
</body>

<!-- Mirrored from pixinvent.com/demo/convex-bootstrap-admin-dashboard-template/demo-1/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Oct 2018 16:18:26 GMT -->
</html>